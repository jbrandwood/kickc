...
// init_angle_screen(byte* zp($f) screen)
init_angle_screen: {
    .label __11 = $15
    .label screen = $f
...
// atan2_16(signed word zp($22) x, signed word zp($24) y)
atan2_16: {
    .label __2 = $13
    .label __7 = $26
    .label yi = $13
...
// bsearch16u(word zp($22) key, word* zp($13) items, byte register(X) num)
bsearch16u: {
    .label __2 = $13
    .label pivot = $24
    .label result = $26
