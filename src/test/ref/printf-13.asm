...
// printf_number_buffer(byte zp($b) buffer_sign, byte* zp(2) buffer_digits, byte zp(8) format_min_length, byte zp($f) format_justify_left, byte zp(4) format_zero_padding, byte zp($e) format_upper_case)
