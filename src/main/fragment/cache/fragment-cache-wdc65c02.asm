...
bcc {la1}
beq {la1}
//FRAGMENT vbuz1=vwum2_band_vbuc1
lda #{c1}
and {m2}
sta {z1}
//FRAGMENT vbum1=_deref_pbuc1_ror_7
lda {c1}
rol
rol
and #$01
...
asl
sta {m1}
//FRAGMENT pbum1=qbuc1_derefidx_vbum2
ldy {m2}
lda {c1},y
sta {m1}
lda {c1}+1,y
sta {m1}+1
//FRAGMENT vbum1=_deref_pbum2_band_vbuc1
ldy {m2}
sty $fe
ldy {m2}+1
sty $ff
...
ora {m3}
sta {m1}
//FRAGMENT vbum1=_byte0_pbum2
lda {m2}
sta {m1}
//FRAGMENT vbum1=_byte1_pbum2
lda {m2}+1
sta {m1}
...
ora {m2}
sta {m1}
//FRAGMENT pbum1=pbum1_plus_vwuz2
clc
lda {m1}
adc {z2}
sta {m1}
...
lda {c1},y
sta {z1}
//FRAGMENT vbsz1=pbsc1_derefidx_vbum2
ldy {m2}
lda {c1},y
sta {z1}
...
adc #>{c1}
sta {m1}+1
//FRAGMENT _deref_pwum1=vwum2
NO_SYNTHESIS
//FRAGMENT pbum1=pbuc1_plus_vwum2
lda {m2}
clc
adc #<{c1}
sta {m1}
...
asl {m1}
rol {m1}+1
//FRAGMENT pdum1=pduc1_plus_vwum2
lda {m2}
clc
adc #<{c1}
sta {m1}
...
ror
sta {m1}
//FRAGMENT vwum1=vwum2_bxor_vwum3
lda {m2}
eor {m3}
sta {m1}
lda {m2}+1
...
rol {z1}+2
rol {z1}+3
//FRAGMENT vbum1=_byte0_pvom2
lda {m2}
sta {m1}
//FRAGMENT vbum1=_byte1_pvom2
lda {m2}+1
sta {m1}
...
ora {m2}
sta {m1}
//FRAGMENT vduz1_lt_vdum2_then_la1
lda {z1}+3
cmp {m2}+3
bcc {la1}
bne !+
...
and {z2}
sta {z1}
//FRAGMENT vbuaa=vwum1_band_vbuc1
lda #{c1}
and {m1}
//FRAGMENT vbuxx=vwum1_band_vbuc1
lda #{c1}
and {m1}
tax
//FRAGMENT vbuyy=vwum1_band_vbuc1
lda #{c1}
and {m1}
tay
//FRAGMENT vbum1=vbuc1_rol_vbuaa
tay
lda #{c1}
cpy #0
beq !e+
...
!e:
sta {m1}
//FRAGMENT vbum1=vbuc1_rol_vbuxx
lda #{c1}
cpx #0
beq !e+
!:
...
!e:
sta {m1}
//FRAGMENT vbum1=vbuc1_rol_vbuyy
lda #{c1}
cpy #0
beq !e+
!:
...
!e:
sta {m1}
//FRAGMENT vbuaa=vbuc1_rol_vbum1
lda #{c1}
ldy {m1}
cpy #0
beq !e+
...
bne !-
!e:
//FRAGMENT vbuxx=vbuc1_rol_vbum1
lda #{c1}
ldx {m1}
cpx #0
beq !e+
...
!e:
tax
//FRAGMENT vbuyy=vbuc1_rol_vbum1
lda #{c1}
ldy {m1}
cpy #0
beq !e+
...
asl
sta {m1}
//FRAGMENT pbum1=qbuc1_derefidx_vbuaa
tay
lda {c1},y
sta {m1}
lda {c1}+1,y
sta {m1}+1
//FRAGMENT pbum1=qbuc1_derefidx_vbuxx
lda {c1},x
sta {m1}
lda {c1}+1,x
sta {m1}+1
//FRAGMENT pbum1=qbuc1_derefidx_vbuyy
lda {c1},y
sta {m1}
lda {c1}+1,y
sta {m1}+1
//FRAGMENT vbuaa=_deref_pbum1_band_vbuc1
ldy {m1}
sty $fe
ldy {m1}+1
sty $ff
...
lda ($fe),y
and #{c1}
//FRAGMENT vbuxx=_deref_pbum1_band_vbuc1
ldy {m1}
sty $fe
ldy {m1}+1
sty $ff
...
and #{c1}
tax
//FRAGMENT vbuyy=_deref_pbum1_band_vbuc1
ldy {m1}
sty $fe
ldy {m1}+1
sty $ff
...
lsr
tay
//FRAGMENT vbum1=vbuaa_ror_4
lsr
lsr
lsr
lsr
sta {m1}
//FRAGMENT vbum1=vbuxx_ror_4
txa
lsr
lsr
lsr
...
lsr
sta {m1}
//FRAGMENT vbuaa=vbum1_ror_6
lda {m1}
rol
rol
rol
and #$03
//FRAGMENT vbuxx=vbum1_ror_6
lda {m1}
rol
rol
rol
...
and #$03
tay
//FRAGMENT vbum1=vbuaa_ror_6
rol
rol
rol
and #$03
sta {m1}
//FRAGMENT vbum1=vbuxx_ror_6
txa
rol
rol
rol
...
and #$03
sta {m1}
//FRAGMENT pwuc1_derefidx_vbuxx=vwum1
lda {m1}
sta {c1},x
lda {m1}+1
sta {c1}+1,x
...
ora {m2}
sta {m1}
//FRAGMENT vbum1=vbum2_bor_vbuxx
txa
ora {m2}
sta {m1}
//FRAGMENT vbum1=vbum2_bor_vbuyy
tya
ora {m2}
sta {m1}
...
sta {m1}
//FRAGMENT vbuaa=_byte0_pbum1
lda {m1}
//FRAGMENT vbuxx=_byte0_pbum1
ldx {m1}
//FRAGMENT vbuaa=_byte1_pbum1
lda {m1}+1
//FRAGMENT vbuxx=_byte1_pbum1
ldx {m1}+1
//FRAGMENT vbuaa=_deref_pbum1
ldy {m1}
sty $fe
ldy {m1}+1
sty $ff
...
ldx {m1}
ldy {c1},x
//FRAGMENT vbsaa=pbsc1_derefidx_vbum1
ldy {m1}
lda {c1},y
//FRAGMENT vbsxx=pbsc1_derefidx_vbum1
ldy {m1}
ldx {c1},y
//FRAGMENT vbsyy=pbsc1_derefidx_vbum1
ldx {m1}
ldy {c1},x
...
cmp #0
beq {la1}
//FRAGMENT vbuaa=_byte0_pvom1
lda {m1}
//FRAGMENT vbuxx=_byte0_pvom1
ldx {m1}
//FRAGMENT vbuaa=_byte1_pvom1
lda {m1}+1
//FRAGMENT vbuxx=_byte1_pvom1
ldx {m1}+1
//FRAGMENT vbuaa=vbuc1_bor_vbum1
lda #{c1}
ora {m1}
//FRAGMENT vbuxx=vbuc1_bor_vbum1
lda #{c1}
ora {m1}
tax
//FRAGMENT vbuyy=vbuc1_bor_vbum1
lda #{c1}
ora {m1}
tay
//FRAGMENT vbum1=vbuc1_bor_vbuxx
txa
ora #{c1}
sta {m1}
//FRAGMENT vbum1=vbuc1_bor_vbuyy
tya
ora #{c1}
sta {m1}
...
txa
sta {c1},y
//FRAGMENT vbuyy=_byte0_pbum1
ldy {m1}
//FRAGMENT vbuyy=_byte0_pvom1
ldy {m1}
//FRAGMENT vbuyy=_byte1_pvom1
ldy {m1}+1
...
ldy {m1}+1
//FRAGMENT vbum1=vbuyy_bor_vbuaa
sty $ff
ora $ff
sta {m1}
//FRAGMENT vdum1=vdum1_ror_1
lsr {m1}+3
ror {m1}+2
ror {m1}+1
ror {m1}
...
eor {m2}+1
sta {m1}+1
//FRAGMENT vbum1=vbum1_bor_vbuaa
ora {m1}
sta {m1}
...
adc #>{c1}
sta {m1}+1
//FRAGMENT pdum1=pduc1_plus_vwum1
lda {m1}
clc
adc #<{c1}
sta {m1}
...
adc {z2}+1
sta {m1}+1
//FRAGMENT vwsm1=vwsm1_plus_vwsm2
clc
lda {m1}
adc {m2}
sta {m1}
...
lda {m2}
sta {m1}
//FRAGMENT _deref_(_deref_qbuc1)=vbum1
lda {m1}
ldy {c1}
sty $fe
ldy {c1}+1
...
ldy {z1}
sta {c1},y
//FRAGMENT vbum1=_deref_(_deref_qbuc1)
ldy {c1}
sty $fe
ldy {c1}+1
sty $ff
...
adc #0
sta {z1}+3
//FRAGMENT vbuaa=_byte0_vwum1
lda {m1}
//FRAGMENT vbuxx=_byte0_vwum1
ldx {m1}
