   ...
   public CParser(Program program) {
      ...
      parser.addErrorListener(new BaseErrorListener() {
         ...
         public void syntaxError(
            ...
            StatementSource source = new StatementSource(recognizer.getInputStream().getSourceName(), line, null, charPositionInLine, charPositionInLine);
   ...
   public KickCLexer makeLexer(CharStream charStream) {
      ...
      lexer.addErrorListener(new BaseErrorListener() {
         ...
         public void syntaxError(
               ...
               String msg,
               RecognitionException e) {
            StatementSource source = new StatementSource(charStream.getSourceName(), line, null, charPositionInLine, charPositionInLine);
            throw new CompileError("Error parsing file: " + msg, source);
         }
      });
      return lexer;
