...
// mulu16_sel(word zp($18) v1, word zp($1a) v2, byte register(X) select)
mulu16_sel: {
    .label __0 = $20
    .label __1 = $20
    .label v1 = $18
...
// mul16u(word zp($24) a, word zp($1a) b)
mul16u: {
    .label mb = $14
    .label a = $24
    .label res = $20
...
div32u16u: {
    .label quotient_hi = $26
    .label quotient_lo = $24
    .label return = $1c
...
// divr16u(word zp($1a) dividend, word zp($18) rem)
divr16u: {
    .label rem = $18
    .label dividend = $1a
    .label quotient = $24
