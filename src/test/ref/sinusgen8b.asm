...
// print_sbyte(signed byte zp($1a) b)
print_sbyte: {
    .label b = $1a
    // if(b<0)
    lda.z b
...
// sin16s_gen(signed word* zp($16) sintab)
sin16s_gen: {
    .label __2 = $18
    .label step = $1e
    .label sintab = $16
...
// mulu16_sel(word zp($10) v1, word zp($1c) v2, byte register(X) select)
mulu16_sel: {
    .label __0 = $22
    .label __1 = $22
    .label v1 = $10
...
// mul16u(word zp($12) a, word zp($1c) b)
mul16u: {
    .label mb = $c
    .label a = $12
    .label res = $22
...
// divr16u(word zp($1c) dividend, word zp($10) rem)
divr16u: {
    .label rem = $10
    .label dividend = $1c
    .label quotient = $12
...
// sintab - the table to generate into
// wavelength - the number of sinus points in a total sinus wavelength (the size of the table)
// sin8s_gen(signed byte* zp($18) sintab)
sin8s_gen: {
    .label step = $12
    .label sintab = $18
    // u[4.12]
...
// mulu8_sel(byte register(X) v1, byte register(Y) v2, byte zp($1b) select)
mulu8_sel: {
    .label __0 = $28
    .label __1 = $28
    .label select = $1b
