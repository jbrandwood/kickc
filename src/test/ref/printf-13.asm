...
// printf_number_buffer(byte zp(7) buffer_sign, byte* zp(2) buffer_digits, byte register(X) format_min_length, byte zp($d) format_justify_left, byte zp($e) format_zero_padding)
printf_number_buffer: {
    .label __18 = $b
    .label buffer_sign = 7
    .label format_justify_left = $d
...
// utoa(word zp(2) value, byte* zp($b) buffer, byte register(X) radix)
utoa: {
    .label buffer = $b
...
// utoa_append(byte* zp($b) buffer, word zp(2) value, word zp($13) sub)
utoa_append: {
    .label buffer = $b
    .label value = 2
    .label sub = $13
...
// printf_sint(signed word zp(2) value, byte zp($d) format_justify_left, byte register(X) format_sign_always, byte zp($e) format_zero_padding)
printf_sint: {
    .label value = 2
    .label format_justify_left = $d
    .label format_zero_padding = $e
...
// printf_string(byte* zp(2) str, byte zp($d) format_justify_left)
printf_string: {
    .label __9 = $b
    .label padding = $e
    .label format_justify_left = $d
