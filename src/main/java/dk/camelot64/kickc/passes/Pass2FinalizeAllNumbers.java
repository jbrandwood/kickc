...
/**
 * Finalize any constant integers to the smallest fixed size signed/unsigned type - even if they have not been resolved as snumber/unumber.
 */
public class Pass2FinalizeAllNumbers extends Pass2SsaOptimization {

   public Pass2FinalizeAllNumbers(Program program) {
      super(program);
   }
