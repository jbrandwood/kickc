...
sta {z1}+2
sta {z1}+3
//FRAGMENT vduz1=vbuaa
sta {z1}
lda #0
sta {z1}+1
sta {z1}+2
sta {z1}+3
//FRAGMENT vduz1=vbuxx
txa
sta {z1}
lda #0
sta {z1}+1
...
lda {c1}+3
sta {z1}+3
//FRAGMENT vwuz1=vbuc1_rol_vbuz2
lda #{c1}
ldy {z2}
sta {z1}
lda #0
...
bne !-
!e:
//FRAGMENT vwuz1=vbuc1_rol_vbuxx
lda #{c1}
sta {z1}
lda #0
sta {z1}+1
...
bne !-
!e:
//FRAGMENT vwuz1=vbuc1_rol_vbuyy
lda #{c1}
sta {z1}
lda #0
sta {z1}+1
