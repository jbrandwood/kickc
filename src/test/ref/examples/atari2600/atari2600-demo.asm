...
main: {
    // TIA->PF0 = 0b10100000
    lda #$a0
    sta.z TIA+OFFSET_STRUCT_ATARI_TIA_WRITE_PF0
    // TIA->PF1 = 0b01010101
    lda #$55
    sta.z TIA+OFFSET_STRUCT_ATARI_TIA_WRITE_PF1
    // TIA->PF2 = 0b10101010
    lda #$aa
    sta.z TIA+OFFSET_STRUCT_ATARI_TIA_WRITE_PF2
    // TIA->COLUPF = 0x55
    lda #$55
    sta.z TIA+OFFSET_STRUCT_ATARI_TIA_WRITE_COLUPF
    lda #0
    sta.z idx
  __b2:
    // TIA->VSYNC = 2
  ...
  __b7:
    ...
    stx.z TIA+OFFSET_STRUCT_ATARI_TIA_WRITE_PF0
    // TIA->PF1 = c
    stx.z TIA+OFFSET_STRUCT_ATARI_TIA_WRITE_PF1
    // TIA->PF2 = c
    stx.z TIA+OFFSET_STRUCT_ATARI_TIA_WRITE_PF2
    // TIA->HMOVE = c
    stx.z TIA+OFFSET_STRUCT_ATARI_TIA_WRITE_HMOVE
    // c++;
    inx
    // for(char i=0;i<192;i++)
    iny
