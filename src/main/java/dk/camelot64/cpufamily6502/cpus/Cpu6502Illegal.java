...
public class Cpu6502Illegal extends Cpu65xx {
   ...
   public Cpu6502Illegal() {
      ...
      addOpcode(0x0f, "slo", CpuAddressingMode.ABS, 6.0, "Acnz");
      addOpcode(0x13, "slo", CpuAddressingMode.IZY, 8.0, "Acnz");
      addOpcode(0x17, "slo", CpuAddressingMode.ZPX, 6.0, "Acnz");
      addOpcode(0x1b, "slo", CpuAddressingMode.ABY, 7.0, "Acnz");
      ...
      addOpcode(0x3b, "rla", CpuAddressingMode.ABY, 7.0, "Acnz");
      addOpcode(0x3f, "rla", CpuAddressingMode.ABX, 7.0, "Acnz");
      addOpcode(0x43, "sre", CpuAddressingMode.IZX, 8.0, "Acnz");
      addOpcode(0x47, "sre", CpuAddressingMode.ZP, 5.0, "Acnz");
      addOpcode(0x4b, "alr", CpuAddressingMode.IMM, 2.0, "Acnz");
      addOpcode(0x4f, "sre", CpuAddressingMode.ABS, 6.0, "Acnz");
      addOpcode(0x53, "sre", CpuAddressingMode.IZY, 8.0, "Acnz");
      addOpcode(0x57, "sre", CpuAddressingMode.ZPX, 6.0, "Acnz");
      addOpcode(0x5b, "sre", CpuAddressingMode.ABY, 7.0, "Acnz");
      addOpcode(0x5f, "sre", CpuAddressingMode.ABX, 7.0, "Acnz");
      addOpcode(0x63, "rra", CpuAddressingMode.IZX, 8.0, "Acvnz");
      addOpcode(0x67, "rra", CpuAddressingMode.ZP, 5.0, "Acvnz");
      addOpcode(0x6b, "arr", CpuAddressingMode.IMM, 2.0, "Acvnz");
      addOpcode(0x6f, "rra", CpuAddressingMode.ABS, 6.0, "Acvnz");
      addOpcode(0x73, "rra", CpuAddressingMode.IZY, 8.0, "Acvnz");
      addOpcode(0x77, "rra", CpuAddressingMode.ZPX, 6.0, "Acvnz");
      addOpcode(0x7b, "rra", CpuAddressingMode.ABY, 7.0, "Acvnz");
      addOpcode(0x7f, "rra", CpuAddressingMode.ABX, 7.0, "Acvnz");
      addOpcode(0x83, "sax", CpuAddressingMode.IZX, 6.0, "");
      addOpcode(0x87, "sax", CpuAddressingMode.ZP, 3.0, "");
      addOpcode(0x8b, "xaa", CpuAddressingMode.IMM, 2.0, "Anz");
      ...
      addOpcode(0xa3, "lax", CpuAddressingMode.IZX, 6.0, "AXnz");
      addOpcode(0xa7, "lax", CpuAddressingMode.ZP, 3.0, "AXnz");
      addOpcode(0xab, "lax", CpuAddressingMode.IMM, 2.0, "AXnz");
      addOpcode(0xaf, "lax", CpuAddressingMode.ABS, 4.0, "AXnz");
      addOpcode(0xb3, "lax", CpuAddressingMode.IZY, 5.5, "AXnz");
      addOpcode(0xb7, "lax", CpuAddressingMode.ZPY, 4.0, "AXnz");
      addOpcode(0xbb, "las", CpuAddressingMode.ABY, 4.5, "AXnz");
      addOpcode(0xbf, "lax", CpuAddressingMode.ABY, 4.5, "AXnz");
      addOpcode(0xc3, "dcp", CpuAddressingMode.IZX, 8.0, "cnz");
      addOpcode(0xc7, "dcp", CpuAddressingMode.ZP, 5.0, "cnz");
      addOpcode(0xcb, "axs", CpuAddressingMode.IMM, 2.0, "Xcnz");
      addOpcode(0xcf, "dcp", CpuAddressingMode.ABS, 6.0, "cnz");
      ...
      addOpcode(0xff, "isc", CpuAddressingMode.ABX, 7.0, "Acvnz");
   }
